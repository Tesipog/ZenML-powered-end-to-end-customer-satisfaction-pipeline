from pipeline_deploy import continuous_deployment_pipeline,inference_pipeline
import click
...
def main(config: str, min_accuracy: float):
    ...
    if deploy:
        continuous_deployment_pipeline(
            data_path=r"C:\Users\krish\PycharmProjects\python\MLops\olist_customers_dataset.csv",
